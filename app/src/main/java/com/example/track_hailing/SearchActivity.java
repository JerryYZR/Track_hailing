...
import android.view.WindowManager;
        ...
        import com.example.track_hailing.MyLetterListView.OnTouchingLetterChangedListener;

public class SearchActivity extends AppCompatActivity implements AMapLocationListener,AbsListView.OnScrollListener {
    ...
    private EditText sh;
    private TextView tv_noresult,cancel_search;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        personList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 4) {
                    ...
                    myapplication.setCity(allCity_lists.get(position).getName());
                    finish();
                }
            }
        });
        ...
        resultList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                myapplication = (Myapplication) getApplication();
                myapplication.setCity(city_result.get(position).getName());
                finish();
            }
        });
        initOverlay();
...
//					mLocationClient.stop();
                ...
                rencentCity.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        myapplication = (Myapplication) getApplication();
                        myapplication.setCity(city_history.get(position));
                        finish();
                ...
                hotCity.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        myapplication = (Myapplication) getApplication();
                        myapplication.setCity(city_hot.get(position).getName());
                        finish();
